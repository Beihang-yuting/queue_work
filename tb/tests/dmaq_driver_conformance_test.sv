...
class dmaq_driver_conformance_test extends uvm_test;
    ...
    gq_monitor monitors[int unsigned];
    ...
    function void build_phase(uvm_phase phase);
        ...
        for (int unsigned queue_id = 0; queue_id < QUEUE_COUNT;
            ...
            monitor_name = $sformatf("monitor_%0d", queue_id);
            ...
            if (queue_id != TIME_AT_Q)
                monitors[queue_id] = gq_monitor::type_id::create(
                    monitor_name, this);
            else
    ...
    function void connect_phase(uvm_phase phase);
        ...
        for (int unsigned queue_id = 0; queue_id < QUEUE_COUNT;
            ...
            if (monitors.exists(queue_id)) begin
                monitors[queue_id].engine = engines[queue_id];
                engines[queue_id].bind_completion_port(
                    monitors[queue_id].completion_ap);
                monitors[queue_id].completion_ap.connect(
