...
class gq_worker_wakeup_test extends uvm_test;
    ...
    task run_phase(uvm_phase phase);
        ...
        fork : idle_worker
            begin
                idle_engine.run_completion_monitor();
        ...
        fork : adaptive_worker
            begin
                adaptive_engine.run_completion_monitor();
        ...
        fork : timeout_worker
            begin
                timeout_engine.run_completion_monitor();
        ...
        fork : lost_irq_worker
            begin
                lost_irq_engine.run_completion_monitor();
        ...
        fork : late_watchdog_worker
            begin
                late_watchdog_engine.run_completion_monitor();
        ...
        fork : invalid_deadline_worker
            begin
                invalid_deadline_engine.run_completion_monitor();
        ...
        fork : rx_worker
            begin
                rx_engine.run_completion_monitor();
