...
class tlpq_driver_conformance_test extends uvm_test;
    ...
    uvm_analysis_port #(gq_desc_base)
        driver_completion_ports[int unsigned];
    ...
    function void build_driver_engine(
        ...
        driver_completion_ports[engine_id] = new(
            $sformatf("driver_completion_port_%0d", engine_id), this);
    ...
    function void connect_phase(uvm_phase phase);
        ...
        for (int unsigned engine_id = 0;
             engine_id < DRIVER_ENGINE_COUNT; engine_id++) begin
            driver_engines[engine_id].bind_completion_port(
                driver_completion_ports[engine_id]);
            driver_completion_ports[engine_id].connect(
    ...
    task start_driver_worker(int unsigned engine_id);
        ...
        fork
            begin
                driver_engines[worker_engine].run_completion_monitor();
